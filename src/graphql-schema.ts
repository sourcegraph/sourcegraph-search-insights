...
export interface ILSIFQueryResolver {
...
export interface IDefinitionsOnLSIFQueryResolverArguments {
    line: number
    character: number
}

export interface IReferencesOnLSIFQueryResolverArguments {
    line: number
    character: number
    after?: string | null
    first?: number | null
...
export interface IHoverOnLSIFQueryResolverArguments {
    line: number
    character: number
}
...
export interface ILSIFUploadFailureReason {
...
export interface IPreviewFileDiffConnection {
    __typename: 'PreviewFileDiffConnection'
    nodes: IPreviewFileDiff[]
    totalCount: number | null
    pageInfo: IPageInfo
    diffStat: IDiffStat
    rawDiff: string
...
export interface IPreviewFileDiff {
...
export interface IExternalChangesetConnection {
    __typename: 'ExternalChangesetConnection'
    nodes: IExternalChangeset[]
    totalCount: number
    pageInfo: IPageInfo
}
...
export interface ICodeIntelUsageStatisticsOnSiteArguments {
    days?: number | null
    weeks?: number | null
    months?: number | null
}
...
export interface ICriticalConfiguration {
...
export interface ICodeIntelUsageStatistics {
    __typename: 'CodeIntelUsageStatistics'
    daily: ICodeIntelUsagePeriod[]
    weekly: ICodeIntelUsagePeriod[]
    monthly: ICodeIntelUsagePeriod[]
}

export interface ICodeIntelUsagePeriod {
...
export interface ICodeIntelEventCategoryStatistics {
...
export interface ICodeIntelEventStatistics {
...
export interface ICodeIntelEventLatencies {
...
export interface IRetryCampaignOnMutationArguments {
    campaign: ID
}
...
export interface IPublishCampaignOnMutationArguments {
    campaign: ID
}
